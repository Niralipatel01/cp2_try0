    ...
    <>
      ...
      >
        <div className="max-h-[97vh] overflow-y-auto md:w-[100%] sm:w-[100%]">
          <div className="bg-white_A700 flex flex-col items-center justify-end p-[32px] md:px-[20px] sm:px-[20px] rounded-radius4 shadow-bs3 w-[100%]">
            <Img
              src="images/img_12.svg"
              className="h-[175px] mt-[32px] w-[42%]"
              alt="Twelve"
            />
            <div className="flex flex-col gap-[21px] items-center justify-start mt-[58px] md:w-[100%] sm:w-[100%] w-[81%]">
              <Text
