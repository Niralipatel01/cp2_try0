    ...
    <>
      ...
      >
        <div className="max-h-[97vh] overflow-y-auto md:w-[100%] sm:w-[100%]">
          <div className="bg-white_A700 flex flex-col gap-[32px] items-center justify-start mb-[18px] p-[32px] md:px-[20px] sm:px-[20px] rounded-radius4 shadow-bs3 w-[100%]">
            <div className="flex flex-col gap-[20px] items-start justify-end pr-[4px] py-[4px] md:w-[100%] sm:w-[100%] w-[101%]">
              <Text
