    ...
    <>
      ...
      >
        <div className="max-h-[97vh] overflow-y-auto md:w-[100%] sm:w-[100%]">
          <div className="bg-white_A700 flex flex-col items-center justify-end mt-[64px] p-[32px] md:px-[20px] sm:px-[20px] rounded-radius4 shadow-bs3 w-[100%]">
            <Img
              src="images/img_layer2.svg"
              className="h-[152px] mt-[86px] w-[56%]"
              alt="LayerTwo"
            />
            <div className="flex flex-col gap-[16px] items-center justify-start mt-[45px] md:w-[100%] sm:w-[100%] w-[74%]">
              <Text
            ...
            <div className="flex flex-row gap-[16px] items-center justify-center mt-[16px] md:w-[100%] sm:w-[100%] w-[53%]">
              <Button
              ...
              <Button
                className="common-pointer flex h-[48px] items-center justify-center rounded-radius50 w-[48px]"
                onClick={() => navigate("")}
                size="xlIcn"
                variant="icbOutlineIndigo51"
              >
