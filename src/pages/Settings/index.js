    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[241px]">
            <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[32px] sm:px-[20px] w-[100%]">
              ...
              <div className="flex flex-col items-start justify-start mb-[492px] md:w-[100%] sm:w-[100%] w-[88%]">
                ...
                <div className="flex flex-row gap-[13px] items-end justify-start mt-[31px] md:w-[100%] sm:w-[100%] w-[62%]">
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[870px] mb-[154px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row gap-[19px] items-end justify-between mb-[155px] mt-[16px] w-[100%]">
                <div className="flex md:flex-1 sm:flex-1 flex-col items-start justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                  ...
                  <div className="bg-white_A700 flex flex-col font-inter gap-[32px] items-start justify-start mt-[32px] p-[32px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                    <div className="flex flex-col gap-[17px] items-start justify-start pr-[5px] pt-[5px] md:w-[100%] sm:w-[100%] w-[62%]">
                      <Text
                    ...
                    <div className="gap-[20px] grid md:grid-cols-1 sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-[100%]">
                  ...
                  <div className="flex md:flex-col sm:flex-col flex-row font-inter gap-[21px] items-center justify-between mt-[20px] w-[100%]">
                    <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                      <div className="flex flex-col items-center justify-end pr-[4px] py-[4px] md:w-[100%] sm:w-[100%] w-[49%]">
                        <Text
                          className="font-bold text-bluegray_900 text-left w-[auto]"
                          as="h4"
                          variant="h4"
                    ...
                    <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-start justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                      <div className="flex flex-col gap-[17px] items-start justify-start pr-[5px] pt-[5px] w-[100%]">
                        <Text
                          className="font-bold text-bluegray_900 text-left w-[auto]"
                          as="h4"
                          variant="h4"
                      ...
                      <div className="flex flex-row gap-[24px] items-center justify-start mt-[42px] md:w-[100%] sm:w-[100%] w-[84%]">
                      ...
                      <div className="flex flex-row gap-[24px] items-end justify-start mt-[32px] md:w-[100%] sm:w-[100%] w-[75%]">
                      ...
                      <div className="flex flex-row gap-[24px] items-end justify-start mb-[20px] mt-[32px] md:w-[100%] sm:w-[100%] w-[70%]">
                ...
                <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col font-inter items-start justify-start md:mt-[0] sm:mt-[0] mt-[56px] p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                  <div className="flex flex-col items-start justify-end md:w-[100%] sm:w-[100%] w-[29%]">
                    <Text
                    ...
                    <SelectBox
                      ...
                      indicator={
                        <Img
                          ...
                          className="h-[20px] mr-[0] pl-[35px] pr-[20px] sm:pl-[20px] border-indigo_51 border border-solid w-[20px] rounded-radius4 py-[18px]"
                          alt="arrow_down"
                        />
                      }
                    ></SelectBox>
                    <div className="bg-indigo_401 flex flex-row items-start justify-between pt-[6px] rounded-radius4 w-[100%]">
                      <div className="md:h-[177px] sm:h-[177px] h-[83px] mt-[94px] relative w-[auto]">
                        <Text
                        ...
                        <Img
                          ...
                          className="absolute h-[83px] inset-y-[0] left-[0] my-[auto] object-cover rounded-radius4 w-[54%]"
                          alt="Group Two"
                        />
                      </div>
                      <div className="h-[161px] md:h-[177px] sm:h-[177px] mb-[16px] relative w-[auto]">
                        <Img
                          src="images/img_group_12X40.svg"
                          className="h-[12px] mt-[13px] mx-[auto] rounded-radius4 w-[51%]"
                          alt="Group Three"
                        />
                        <Img
                          src="images/img_group_161X165.png"
                          className="absolute h-[161px] inset-[0] justify-center m-[auto] object-cover rounded-radius4 w-[100%]"
                          alt="Group Four"
                        />
                      </div>
                    </div>
                  ...
                  <Text
                    className="font-normal leading-[22.00px] md:ml-[0] sm:ml-[0] ml-[45px] mt-[32px] not-italic text-bluegray_400 text-center sm:w-[100%] w-[70%]"
                    as="h6"
                    variant="h6"
                  >
