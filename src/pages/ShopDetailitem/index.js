    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[1979px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            <Header className="bg-white_A700 flex items-center justify-center w-[100%]" />
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start mt-[32px] p-[30px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[48px] items-center justify-start mb-[38px] w-[100%]">
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-start justify-between w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-start pt-[4px] md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="flex flex-row gap-[12px] items-center justify-start w-[100%]">
                          <div className="bg-indigo_401 h-[2px] my-[6px] w-[26%]"></div>
                          <Text
                      ...
                      <div className="flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-start pt-[4px] md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="flex flex-col gap-[19px] items-start justify-start md:w-[100%] sm:w-[100%] w-[86%]">
                          <Text
