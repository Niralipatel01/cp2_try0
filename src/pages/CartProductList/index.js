...
const CartProductListPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row font-inter md:gap-[20px] sm:gap-[20px] items-start mx-[auto] w-[100%]">
        <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[241px]">
          <div className="flex flex-col gap-[36px] items-center justify-start mb-[524px] ml-[32px] mr-[54px] mt-[36px] w-[65%]">
            ...
            <div className="flex flex-col items-start justify-start w-[100%]">
              ...
              <div className="flex flex-row gap-[16px] items-center justify-start mt-[33px] md:w-[100%] sm:w-[100%] w-[43%]">
                <Img
        ...
        <div className="flex-1 h-[1071px] md:h-[1076px] sm:h-[1076px] md:px-[20px] sm:px-[20px] relative w-[100%]">
          <div className="absolute bg-gray_51 bottom-[0] flex flex-col inset-x-[0] items-center justify-end mx-[auto] p-[24px] sm:px-[20px] w-[100%]">
            <div className="flex flex-col gap-[35px] items-center justify-start mt-[14px] w-[100%]">
              ...
              <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-start justify-between w-[100%]">
                <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-start justify-end p-[24px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                  <Text
                    className="font-bold md:ml-[0] sm:ml-[0] ml-[8px] mt-[13px] text-bluegray_900 text-left w-[auto]"
                    as="h4"
                    variant="h4"
                  >
                    Product List
                  </Text>
                  <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start md:ml-[0] sm:ml-[0] ml-[28px] mt-[39px] md:w-[100%] sm:w-[100%] w-[93%]">
                    ...
                    <Text
                      className="font-normal md:ml-[0] sm:ml-[0] ml-[32px] not-italic text-bluegray_400 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Product
                    ...
                    <Text
                      className="font-normal md:ml-[0] sm:ml-[0] ml-[201px] not-italic text-bluegray_400 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Price
                    ...
                    <Text
                      className="font-normal md:ml-[0] sm:ml-[0] ml-[74px] not-italic text-bluegray_400 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Quantity
                    ...
                    <Text
                      className="font-normal md:ml-[0] sm:ml-[0] ml-[96px] not-italic text-bluegray_400 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Total
                  ...
                  <List
                    className="flex-col gap-[12px] grid items-center md:ml-[0] sm:ml-[0] ml-[8px] mt-[16px] md:w-[100%] sm:w-[100%] w-[98%]"
                    orientation="vertical"
                  >
                    <div className="flex flex-col items-center justify-start w-[100%]">
                      <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-start p-[8px] w-[100%]">
                        <CheckBox
                          className="md:flex-1 sm:flex-1 h-[16px] md:ml-[0] sm:ml-[0] ml-[13px] md:mt-[0] sm:mt-[0] mt-[34px] md:w-[100%] sm:w-[100%]"
                          inputClassName="md:w-[100%] mr-[5px] sm:w-[100%] w-[undefinedpx]"
                          name="file Two"
                        ></CheckBox>
                        <div className="flex md:flex-1 sm:flex-1 flex-row gap-[24px] items-start justify-center md:ml-[0] sm:ml-[0] ml-[33px] md:w-[100%] sm:w-[100%] w-[34%]">
                          <Img
                            src="images/img_rectangle_564X524.png"
                            className="h-[86px] md:h-[auto] sm:h-[auto] object-cover w-[35%]"
                            alt="Rectangle"
                          />
                        ...
                        <Text
                          className="font-semibold md:ml-[0] sm:ml-[0] ml-[30px] md:mt-[0] sm:mt-[0] mt-[3px] text-bluegray_800 text-left w-[auto]"
                          as="h6"
                          variant="h6"
                        >
                          $120.0
                        </Text>
                        <div className="flex md:flex-1 sm:flex-1 flex-row items-center justify-center md:ml-[0] sm:ml-[0] ml-[66px] md:w-[100%] sm:w-[100%] w-[17%]">
                          <Button
                        ...
                        <Text
                          className="font-semibold md:ml-[0] sm:ml-[0] ml-[49px] md:mt-[0] sm:mt-[0] mt-[3px] text-bluegray_800 text-left w-[auto]"
                          as="h6"
                          variant="h6"
                        >
                          $120.0
                    ...
                    <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-start p-[8px] w-[100%]">
                      <div className="flex sm:flex-1 flex-col h-[20px] items-center justify-end md:ml-[0] sm:ml-[0] ml-[12px] md:mt-[0] sm:mt-[0] mt-[33px] sm:w-[100%] w-[20px]">
                        <CheckBox
                          className="h-[16px]"
                          inputClassName="mr-[5px] w-[undefinedpx]"
                          name="file Three"
                      ...
                      <div className="flex md:flex-1 sm:flex-1 flex-row gap-[24px] items-start justify-center md:ml-[0] sm:ml-[0] ml-[32px] md:w-[100%] sm:w-[100%] w-[34%]">
                        <Img
                ...
                <div className="flex md:flex-1 sm:flex-1 flex-col gap-[20px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                  <div className="bg-white_A700 flex flex-col gap-[24px] items-center justify-end p-[32px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                    ...
                    <div className="flex flex-row gap-[12px] items-center justify-center md:w-[100%] sm:w-[100%] w-[70%]">
                      <Img
