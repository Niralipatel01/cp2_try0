              ...
              <div className="flex flex-col gap-[38px] items-start justify-start mb-[75px] mt-[14px] w-[100%]">
                ...
                <div className="flex md:flex-col sm:flex-col flex-row font-inter gap-[20px] items-center justify-between w-[100%]">
                  ...
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[3px] md:w-[100%] sm:w-[100%] w-[99%]">
                      <div className="flex sm:flex-col flex-row sm:gap-[40px] items-center justify-between w-[100%]">
                        <div className="flex sm:flex-1 flex-row gap-[34px] items-end justify-between sm:w-[100%] w-[auto]">
                          <Text
                      ...
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start w-[100%]">
                          <List
                            className="md:flex-1 sm:flex-1 sm:flex-col flex-row sm:gap-[20px] grid sm:grid-cols-1 grid-cols-5 md:w-[100%] sm:w-[100%] w-[72%]"
                            orientation="horizontal"
                          >
                            <div className="border border-indigo_51 border-solid flex flex-col items-center justify-start sm:ml-[0] p-[12px] w-[100%]">
                              <Text
                          ...
                          <div className="border border-indigo_51 border-solid flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[12px] md:w-[100%] sm:w-[100%] w-[16%]">
                            <Text
                              className="font-semibold mb-[5px] text-bluegray_800 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                        ...
                        <div
                          className="bg-cover bg-no-repeat flex flex-col items-start justify-start p-[16px] w-[100%]"
                          style={{
                            backgroundImage: "url('images/img_group16040.svg')",
                          }}
                        >
                          <div className="bg-deep_orange_300 flex flex-row gap-[9px] items-start justify-start mb-[536px] md:ml-[0] sm:ml-[0] ml-[101px] p-[4px] rounded-radius4 md:w-[100%] sm:w-[100%] w-[14%]">
                            <div className="flex flex-row gap-[8px] items-end justify-center mb-[6px] ml-[12px] w-[71%]">
                              <div className="bg-white_A700 h-[8px] mt-[7px] rounded-radius50 w-[8px]"></div>
                              <Text
