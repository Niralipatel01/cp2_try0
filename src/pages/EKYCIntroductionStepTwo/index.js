...
const EKYCIntroductionStepTwoPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-end mx-[auto] w-[100%]">
              ...
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[75px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col gap-[58px] items-center justify-start p-[80px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  ...
                  <div className="flex flex-col items-center justify-start mb-[60px] md:w-[100%] sm:w-[100%] w-[46%]">
                    ...
                    >
                      <div className="border border-indigo_51 border-solid flex flex-1 flex-row items-center justify-between my-[0] p-[25px] sm:px-[20px] rounded-radius4 shadow-bs1 w-[100%]">
                        <div className="flex flex-row gap-[20px] items-center justify-center ml-[7px] rounded-radius4 w-[auto]">
                          <Img
                            src="images/img_mail_28X28.svg"
                      ...
                      <div
                        className="common-pointer bg-white_A700 flex flex-1 flex-row items-center justify-between my-[0] p-[25px] sm:px-[20px] rounded-radius4 shadow-bs1 w-[100%]"
                        onClick={() => navigate("/ekycscanface")}
                      >
                        <div className="flex flex-row gap-[20px] items-center justify-center ml-[7px] rounded-radius4 w-[auto]">
                          <div
                            className="bg-cover bg-no-repeat md:h-[26px] sm:h-[26px] h-[28px] relative w-[28px]"
                            style={{
                              backgroundImage:
                          ...
                          >
                            <Img
                              ...
                              className="absolute h-[26px] inset-[0] justify-center m-[auto] rounded-radius2 w-[26px]"
                              alt="facebook"
                            />
                          </div>
                      ...
                      <div className="border border-indigo_51 border-solid flex flex-1 flex-row items-center justify-between my-[0] p-[25px] sm:px-[20px] rounded-radius4 shadow-bs1 w-[100%]">
                        <div className="flex flex-row gap-[20px] items-center justify-start ml-[7px] rounded-radius4 w-[auto]">
