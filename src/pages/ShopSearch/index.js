    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[1538px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            <Header className="bg-white_A700 flex items-center justify-center w-[100%]" />
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-start justify-between mb-[25px] mt-[16px] w-[100%]">
                <div className="flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                  <Text
                  ...
                  <div className="flex font-inter md:h-[1045px] sm:h-[1045px] h-[1050px] justify-end relative w-[100%]">
                    <div className="flex flex-col gap-[11px] h-[100%] items-start justify-start mb-[247px] mt-[auto] mx-[auto] pr-[4px] pt-[4px] w-[62%]">
                      <Text
                    ...
                    <div className="absolute bg-white_A700 flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] p-[31px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                      <div className="flex flex-col items-start justify-start mt-[8px] w-[100%]">
                        ...
                        <Accordion
                          preExpanded={[0]}
                          className="gap-[21px] mt-[32px] w-[100%]"
                        >
                          {" "}
                          {[...Array(4)].map((item, index) => (
                            <AccordionItem uuid={index} key={Math.random()}>
                              <div className="flex flex-1 flex-col items-center justify-start pb-[21px] w-[100%]">
                                <div className="flex flex-col gap-[22px] items-start justify-start pt-[2px] w-[100%]">
                                  ...
                                  <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[42%]">
                                    <div className="flex flex-col items-start justify-start p-[3px] w-[100%]">
                                      <Text
                                        className="font-medium md:ml-[0] sm:ml-[0] ml-[5px] text-bluegray_800 text-left w-[auto]"
                                        as="h5"
                                        variant="h5"
                                      >
                                        T-shirts
                                      ...
                                      <Text
                                        className="font-medium md:ml-[0] sm:ml-[0] ml-[5px] mt-[24px] text-bluegray_800 text-left w-[auto]"
                                        as="h5"
                                        variant="h5"
                                      >
                                        Jeans
                        ...
                        <div className="flex flex-col gap-[19px] items-start justify-start mt-[23px] w-[100%]">
                          ...
                          <div className="flex flex-col gap-[8px] items-center justify-start w-[100%]">
                            <SeekBar
                              inputValue={[null]}
                              trackColors={["", "#e2e8ed"]}
                              thumbClassName="w-[undefinedpx] flex justify-center items-center rounded-radius50 outline-none"
                        ...
                        <div className="flex flex-row items-center justify-between mt-[16px] w-[100%]">
                          ...
                          <Img
                            ...
                            className="h-[11px] md:h-[auto] sm:h-[auto] object-cover w-[auto]"
                            alt="Frame One"
                          />
                        </div>
                        <div className="flex flex-row items-center justify-between mt-[16px] w-[100%]">
                        ...
                        <div className="flex flex-row items-center justify-between mt-[16px] w-[100%]">
                          ...
                          <Img
                            ...
                            className="h-[11px] md:h-[auto] sm:h-[auto] object-cover w-[12px]"
                            alt="Vector One"
                          />
                        </div>
                        <div className="flex flex-col gap-[19px] items-start justify-start mt-[24px] md:w-[100%] sm:w-[100%] w-[73%]">
                          <Text
                            className="font-medium text-bluegray_800 text-left w-[auto]"
                            as="h5"
                            variant="h5"
                          ...
                          <div className="flex flex-row gap-[8px] items-center justify-between w-[100%]">
                            <Img
                              ...
                              alt="Icon"
                            />
                            <div className="bg-light_blue_A700 flex flex-col h-[24px] items-center justify-start p-[6px] rounded-radius50 w-[24px]">
                              <div className="bg-white_A700 h-[12px] rounded-radius50 w-[12px]"></div>
                            </div>
                            <div className="bg-pink_400 h-[24px] rounded-radius50 w-[24px]"></div>
                            <div className="bg-amber_302 h-[24px] rounded-radius50 w-[24px]"></div>
                            <div className="bg-pink_A100 h-[24px] rounded-radius50 w-[24px]"></div>
                          </div>
                        </div>
                        <div className="flex flex-col gap-[12px] items-center justify-start mt-[32px] w-[100%]">
                          ...
                          <Button
                            className="cursor-pointer font-semibold text-[14px] text-bluegray_900 text-center w-[210px]"
                            shape="CircleBorder24"
                            size="4xl"
                            variant="FillGray51"
                          >
                ...
                <div className="flex md:flex-1 sm:flex-1 flex-col font-inter items-center justify-start md:mt-[0] sm:mt-[0] mt-[56px] md:w-[100%] sm:w-[100%] w-[auto]">
                  <Input
                    value={inputvalue}
                  ...
                  ></Input>
                  <div className="h-[1186px] md:h-[2399px] sm:h-[3599px] mt-[19px] relative w-[100%]">
                    <div className="absolute bg-white_A700 h-[308px] inset-x-[0] mx-[auto] rounded-radius4 shadow-bs top-[1%] w-[32%]"></div>
                    <div className="bg-white_A700 h-[308px] ml-[auto] mt-[9px] rounded-radius4 shadow-bs w-[32%]"></div>
                    <div className="absolute gap-[0] md:gap-[20px] sm:gap-[20px] grid grid-cols-1 inset-[0] justify-center m-[auto] min-h-[auto] w-[100%]">
                      ...
                      <div className="flex-1 gap-[20px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between w-[100%]">
                        <div
                          className="common-pointer bg-white_A700 flex flex-1 flex-col gap-[32px] items-center justify-start pb-[32px] rounded-radius8 shadow-bs w-[100%]"
                  ...
                  <div className="flex flex-row gap-[8px] items-center justify-center mt-[41px] md:w-[100%] sm:w-[100%] w-[28%]">
                    <Button
