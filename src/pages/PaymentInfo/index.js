    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[750px] mb-[274px] w-[100%]" />
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[43px] mt-[14px] w-[100%]">
                ...
                <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-start p-[31px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[11px] items-start justify-end pr-[4px] py-[4px] md:w-[100%] sm:w-[100%] w-[30%]">
                      <Text
                    ...
                    <div className="flex flex-col items-start justify-start mb-[277px] w-[100%]">
                      <div className="flex flex-col gap-[20px] items-start justify-start md:w-[100%] sm:w-[100%] w-[23%]">
                        <CheckBox
                          className="font-medium text-[14px] text-bluegray_800 text-left sm:w-[100%]"
                        ...
                        <CheckBox
                          className="font-medium text-[14px] text-bluegray_800 text-left sm:w-[100%]"
                          inputClassName="h-[18px] mr-[5px] sm:w-[100%] w-[18px]"
                          label="Credit card"
                          name="Remember One"
                          size="sm"
                      ...
                      <div className="flex flex-col gap-[24px] items-center justify-start mt-[31px] pt-[3px] w-[100%]">
                        ...
                        <div className="flex md:flex-col sm:flex-col flex-row gap-[24px] items-start justify-between pt-[3px] w-[100%]">
