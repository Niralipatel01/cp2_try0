          ...
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[241px]">
            <div className="flex flex-col gap-[36px] items-center justify-start mb-[426px] ml-[32px] mr-[54px] mt-[36px] w-[65%]">
              ...
              <div className="flex flex-col items-start justify-start w-[100%]">
                ...
                <div className="flex flex-row gap-[16px] items-start justify-start mt-[33px] md:w-[100%] sm:w-[100%] w-[63%]">
                  <Img
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[38px] items-start justify-start mb-[75px] mt-[14px] w-[100%]">
                ...
                <div className="flex md:flex-col sm:flex-col flex-row font-inter gap-[20px] items-center justify-between w-[100%]">
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col items-start justify-start mb-[8px] w-[100%]">
                      <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                        ...
                        >
                          <div className="common-pointer bg-transparent cursor-pointer font-semibold text-[14px] text-left text-white_A700">
                            Create new event
                          </div>
                        </Button>
                      </div>
                      ...
                      <Button
                        className="flex items-center justify-center mt-[32px] text-center"
                        leftIcon={
                          <Img
                        ...
                        size="sm"
                      >
                        <div className="bg-transparent cursor-pointer font-normal not-italic text-[16px] text-deep_orange_300 text-left">
                          Add member
                        </div>
                      </Button>
                    </div>
                  ...
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[30px] items-center justify-start md:w-[100%] sm:w-[100%] w-[99%]">
                      <div className="flex sm:flex-col flex-row sm:gap-[40px] items-center justify-between w-[100%]">
                        <div className="flex sm:flex-1 flex-row gap-[35px] items-end justify-between sm:w-[100%] w-[auto]">
                          <Text
                            className="mb-[2px] mt-[12px] text-bluegray_900 text-left w-[auto]"
                            as="h2"
                            variant="h2"
                          >
                            <span className="sm:text-[20px] md:text-[22px] text-bluegray_900 text-[24px] font-inter font-bold">
                              January{" "}
                            </span>
                            <span className="sm:text-[20px] md:text-[22px] text-indigo_401 text-[24px] font-inter font-bold">
                              2022
                            </span>
                          </Text>
                          <div className="flex flex-row gap-[16px] items-center justify-between w-[auto]">
                            <Button
                      ...
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        ...
                        >
                          <div className="flex flex-1 sm:flex-col flex-row sm:gap-[20px] items-center justify-start my-[0] w-[100%]">
                            <Text
                              className="border border-indigo_51 border-solid font-normal not-italic pb-[35px] sm:pl-[20px] pl-[35px] pr-[17px] pt-[16px] text-bluegray_400 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                            >
                              26
                            ...
                            <Text
                              className="border border-indigo_51 border-solid font-normal not-italic pb-[35px] sm:pl-[20px] pl-[35px] pr-[16px] pt-[16px] text-bluegray_400 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                            >
                              27
                            ...
                            <Text
                              className="border border-indigo_51 border-solid font-normal not-italic pb-[35px] sm:pl-[20px] pl-[35px] pr-[17px] pt-[16px] text-bluegray_800 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                            >
                              1
                          ...
                          <div className="flex flex-1 sm:flex-col flex-row sm:gap-[20px] items-center justify-start my-[0] w-[100%]">
                            <Text
                              className="border border-indigo_51 border-solid font-normal not-italic pb-[35px] sm:pl-[20px] pl-[35px] pr-[16px] pt-[16px] text-bluegray_800 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                            >
                              2
                          ...
                          <div className="flex flex-1 md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start my-[0] w-[100%]">
                            <Text
                              className="border border-indigo_51 border-solid font-normal not-italic pb-[35px] sm:pl-[20px] pl-[35px] pr-[17px] pt-[16px] text-bluegray_800 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                            ...
                            <div className="border border-indigo_51 border-solid flex md:flex-1 sm:flex-1 flex-col gap-[20px] justify-start p-[4px] md:w-[100%] sm:w-[100%] w-[15%]">
                              <Text
                                className="font-normal h-[18px] md:ml-[0] sm:ml-[0] ml-[76px] mt-[12px] not-italic text-bluegray_800 text-left w-[auto]"
                                as="h5"
                                variant="h5"
                              >
                                12
                              </Text>
                              <div className="bg-indigo_401 flex flex-col items-end justify-start mb-[12px] pl-[4px] py-[4px] rounded-radius4 w-[100%]">
                                <div className="flex flex-row gap-[9px] items-start justify-end ml-[auto] pb-[6px] pr-[6px] md:w-[100%] sm:w-[100%] w-[89%]">
                                  <Radio
                                    value="810am"
                        ...
                        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start w-[100%]">
                          ...
                          <List
                            className="md:flex-1 sm:flex-1 sm:flex-col flex-row grid grid-cols-2 md:w-[100%] sm:w-[100%] w-[29%]"
                            orientation="horizontal"
                          >
                            <div className="border border-indigo_51 border-solid flex flex-col gap-[20px] justify-start p-[4px] w-[100%]">
                              <Text
                                className="font-normal md:ml-[0] sm:ml-[0] ml-[74px] mt-[12px] not-italic text-bluegray_800 text-left w-[auto]"
                                as="h5"
                                variant="h5"
                              >
                                20
                              </Text>
                              <div className="bg-deep_orange_300 flex flex-col items-end justify-start mb-[12px] pl-[4px] py-[4px] rounded-radius4 w-[100%]">
                                <div className="flex flex-row gap-[9px] items-start justify-end ml-[auto] pb-[6px] pr-[6px] md:w-[100%] sm:w-[100%] w-[89%]">
                                  <Radio
                                    value="810am"
                                    className="font-medium text-[14px] text-left text-white_A700"
                            ...
                            <div className="border border-indigo_51 border-solid flex flex-col gap-[20px] justify-start p-[4px] w-[100%]">
                              <Text
                                className="font-normal md:ml-[0] sm:ml-[0] ml-[78px] mt-[12px] not-italic text-bluegray_800 text-left w-[auto]"
                                as="h5"
                                variant="h5"
                              >
                                21
                              </Text>
                              <div className="bg-red_600 flex flex-col items-end justify-start mb-[12px] pl-[4px] py-[4px] rounded-radius4 w-[100%]">
                                <div className="flex flex-row gap-[9px] items-start justify-end ml-[auto] pb-[6px] pr-[6px] md:w-[100%] sm:w-[100%] w-[89%]">
                                  <Radio
                                    value="810am"
                                    className="font-medium text-[14px] text-left text-white_A700"
                        ...
                        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start w-[100%]">
                          ...
                          <div className="border border-indigo_51 border-solid flex md:flex-1 sm:flex-1 flex-col gap-[20px] justify-start p-[4px] md:w-[100%] sm:w-[100%] w-[15%]">
                            ...
                            <div className="bg-amber_300 flex flex-col items-end justify-start mb-[12px] pl-[4px] py-[4px] rounded-radius4 w-[100%]">
                              <div className="flex flex-row gap-[9px] items-start justify-end ml-[auto] pb-[6px] pr-[6px] md:w-[100%] sm:w-[100%] w-[89%]">
                                <Radio
                                  value="810am"
                                  className="font-medium text-[14px] text-left text-white_A700"
