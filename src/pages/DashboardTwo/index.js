    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[240px]">
            <div className="flex flex-col gap-[36px] items-center justify-start mb-[675px] ml-[31px] mr-[54px] mt-[36px] w-[65%]">
              ...
              <div className="flex flex-col items-start justify-start w-[100%]">
                ...
                <div className="flex flex-row font-medium font-poppins gap-[34px] items-center justify-between mt-[32px] w-[100%]">
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[1542px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            <Header className="bg-white_A700 flex items-center justify-center w-[100%]" />
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start sm:pl-[20px] pl-[23px] w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                <div className="flex md:flex-1 sm:flex-1 flex-col gap-[24px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                  ...
                  <div className="flex flex-col font-inter gap-[20px] items-center justify-start w-[100%]">
                    <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="gap-[20px] grid grid-cols-2 justify-center min-h-[auto] w-[100%]">
                          <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                            <div className="flex flex-col gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[98%]">
                              <Button
                                className="flex h-[48px] items-center justify-center w-[48px]"
                                shape="icbRoundedBorder4"
                                size="xlIcn"
                          ...
                          <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                            <div className="flex flex-col gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[98%]">
                              ...
                              <div className="flex flex-col gap-[13px] justify-end pr-[5px] pt-[5px] w-[100%]">
                                <Text
                                  className="font-bold md:ml-[0] sm:ml-[0] ml-[36px] mr-[42px] text-bluegray_800 text-left w-[auto]"
                                  as="h4"
                                  variant="h4"
                                >
                                  23
                          ...
                          <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                            <div className="flex flex-col gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[98%]">
                              ...
                              <div className="flex flex-col gap-[12px] justify-end pr-[4px] py-[4px] w-[100%]">
                                <Text
                                  className="font-bold md:ml-[0] sm:ml-[0] ml-[36px] mr-[43px] text-bluegray_800 text-left w-[auto]"
                                  as="h4"
                                  variant="h4"
                                >
                                  35
                      ...
                      <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[24px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="flex flex-col items-center justify-start mb-[8px] md:w-[100%] sm:w-[100%] w-[97%]">
                          ...
                          <div className="flex flex-col items-center justify-start mt-[28px] w-[100%]">
                            <div className="flex flex-col gap-[20px] items-end justify-start w-[100%]">
                              <div className="flex flex-row gap-[31px] items-center justify-between mr-[3px] w-[100%]">
                                <div className="flex flex-col gap-[27px] items-start justify-start w-[auto]">
                                  ...
                                  <Text
                                    className="font-normal md:ml-[0] sm:ml-[0] ml-[15px] not-italic text-bluegray_400 text-left w-[auto]"
                                    variant="body1"
                                  >
                                    0
                                  </Text>
                              ...
                              <div className="flex flex-row gap-[34px] items-start justify-start ml-[auto] pb-[2px] px-[2px] md:w-[100%] sm:w-[100%] w-[90%]">
                                <Text
                                  className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                                  variant="body1"
                                >
                          ...
                          <div className="flex flex-row gap-[24px] items-start justify-center mt-[32px] md:w-[100%] sm:w-[100%] w-[38%]">
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                      <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          ...
                          <div className="h-[190px] md:h-[218px] sm:h-[218px] mt-[28px] relative w-[190px]">
                            <div className="h-[190px] md:h-[auto] sm:h-[auto] m-[auto] rounded-radius32 w-[190px]">
                              <CircularProgressbar
                            ...
                            <div className="absolute bottom-[34%] flex flex-col gap-[9px] items-center justify-start right-[31%] w-[35%]">
                              <Text
                          ...
                          <div className="flex flex-row gap-[32px] items-center justify-center mt-[24px] md:w-[100%] sm:w-[100%] w-[72%]">
                            <div className="flex flex-row gap-[12px] items-center justify-between w-[22%]">
                              <div className="bg-green_700 h-[6px] my-[17px] rounded-radius50 w-[6px]"></div>
                            ...
                            <div className="flex flex-row gap-[12px] items-center justify-center pb-[2px] w-[20%]">
                              <div className="bg-indigo_401 h-[6px] mb-[14px] mt-[17px] rounded-radius50 w-[6px]"></div>
                              <div className="flex flex-col gap-[6px] items-start justify-start w-[59%]">
                                <Text
                                  className="font-semibold text-bluegray_900 text-left w-[auto]"
                                  as="h5"
                                  variant="h5"
                            ...
                            <div className="flex flex-row gap-[12px] items-center justify-between w-[30%]">
                              <div className="bg-amber_300 h-[6px] my-[17px] rounded-radius50 w-[6px]"></div>
                              <div className="flex flex-col gap-[6px] items-start justify-start w-[auto]">
                                <Text
                                  className="font-semibold text-bluegray_900 text-left w-[auto]"
                                  as="h5"
                      ...
                      <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="flex flex-col gap-[32px] items-center justify-start mb-[6px] md:w-[100%] sm:w-[100%] w-[98%]">
                          <div className="flex flex-row items-center justify-between w-[100%]">
                            <Text
                              className="font-bold text-bluegray_900 text-left w-[auto]"
                              as="h4"
                            ...
                            <div className="flex flex-row gap-[8px] items-center justify-between w-[auto]">
                              <Button
                            ...
                            >
                              ...
                              <div className="flex flex-1 sm:flex-col flex-row gap-[20px] items-center justify-between my-[0] w-[100%]">
                                ...
                                <div className="flex sm:flex-1 flex-col gap-[11px] items-start justify-start sm:w-[100%] w-[auto]">
                                  ...
                                  <div className="flex flex-row gap-[8px] items-center justify-start md:w-[100%] sm:w-[100%] w-[97%]">
                    ...
                    <div className="bg-white_A700 flex flex-col items-center justify-start p-[30px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                      <div className="flex flex-col items-start justify-start w-[100%]">
                        ...
                        <div className="h-[401px] md:h-[471px] sm:h-[471px] mt-[29px] relative w-[100%]">
                          <div className="absolute bg-gray_51 flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] inset-x-[0] items-center justify-evenly mx-[auto] top-[0] w-[100%]">
                            <div className="flex md:h-[46px] sm:h-[46px] h-[48px] justify-end relative md:w-[100%] sm:w-[100%] w-[13%]">
                              <Text
                              ...
                              <div className="absolute bg-deep_orange_300 flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] p-[16px] w-[100%]">
                                <Text
                            ...
                            <div className="flex md:flex-1 sm:flex-1 md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly md:w-[100%] sm:w-[100%] w-[88%]">
                              <div className="flex flex-col items-center justify-start p-[16px] md:w-[100%] sm:w-[100%] w-[30%]">
                                <Text
                                  className="font-medium text-bluegray_400 text-left w-[auto]"
                                  as="h6"
                                  variant="h6"
                              ...
                              <div className="flex flex-col items-center justify-start p-[16px] md:w-[100%] sm:w-[100%] w-[16%]">
                                <Text
                                  className="font-medium text-bluegray_400 text-left w-[auto]"
                                  as="h6"
                                  variant="h6"
                          ...
                          <div className="absolute bottom-[7%] flex flex-col items-start justify-start left-[2%] w-[6%]">
                            <Text
                            ...
                            <Text
                              className="font-normal md:ml-[0] sm:ml-[0] ml-[2px] mt-[34px] not-italic text-bluegray_400 text-left w-[auto]"
                              variant="body1"
                            >
                              10 am
                            </Text>
                            ...
                            <Text
                              className="font-normal md:ml-[0] sm:ml-[0] ml-[3px] mt-[32px] not-italic text-bluegray_400 text-left w-[auto]"
                              variant="body1"
                            >
                              02 pm
                            </Text>
                            <Text
                              className="font-normal md:ml-[0] sm:ml-[0] ml-[2px] mt-[32px] not-italic text-bluegray_400 text-left w-[auto]"
                              variant="body1"
                            >
                              03 pm
                            </Text>
                          ...
                          <List
                            className="absolute bg-cover bg-no-repeat flex-col gap-[10px] grid inset-y-[0] my-[auto] p-[11px] right-[0] w-[89%]"
                            style={{
                              backgroundImage:
                            ...
                            orientation="vertical"
                          >
                            <div className="bg-white_A700 flex flex-col items-start justify-start ml-[40px] mr-[478px] my-[0] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[25%]">
                              <div className="flex flex-row gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[72%]">
                                ...
                                <div className="flex flex-col items-start justify-start w-[84%]">
                                  ...
                                  <div className="h-[24px] md:h-[85px] sm:h-[85px] mt-[61px] relative rounded-radius12 w-[36%]">
                                    <Img
                                      src="images/img_robototoyfacefi.png"
                                      className="absolute h-[24px] inset-y-[0] left-[0] my-[auto] rounded-radius50 w-[24px]"
                                      alt="RobotoToyFaceFi"
                                    />
                                    <Img
                                      src="images/img_fidenza978toy.png"
                                      className="absolute h-[24px] inset-y-[0] my-[auto] right-[0] rounded-radius50 w-[24px]"
                                      alt="Fidenza978Toy"
                                    />
                                  </div>
                                </div>
                            ...
                            <div className="bg-white_A700 flex flex-col items-start justify-start ml-[297px] mr-[289px] my-[0] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[15%]">
                              <div className="flex flex-row gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[77%]">
                                <Line className="bg-indigo_401 h-[137px] rounded-radius4 w-[4px]" />
                                <div className="flex flex-col items-start justify-start w-[74%]">
                                  ...
                                  <div className="h-[24px] md:h-[51px] sm:h-[51px] mt-[27px] relative rounded-radius12 w-[65%]">
                                    <Img
                                      src="images/img_robototoyfacefi.png"
                                      className="absolute h-[24px] inset-y-[0] left-[0] my-[auto] rounded-radius50 w-[24px]"
                ...
                <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[16px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                  <div className="flex flex-col items-center justify-start mb-[27px] md:w-[100%] sm:w-[100%] w-[89%]">
                    <div className="flex flex-row items-center justify-between w-[100%]">
                      <Text
                        className="font-medium text-bluegray_900 text-left w-[auto]"
                        as="h4"
