    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          <div className="h-[1024px] md:h-[1026px] sm:h-[1026px] md:px-[20px] sm:px-[20px] relative md:w-[100%] sm:w-[100%] w-[17%]">
            <Line className="bg-indigo_51 h-[690px] ml-[auto] mr-[21px] mt-[60px] w-[1px]" />
            <div className="absolute bg-white_A700 flex flex-col gap-[36px] h-[max-content] inset-[0] items-center justify-center m-[auto] p-[32px] sm:px-[20px] w-[100%]">
              <Img
          ...
          <Line className="bg-indigo_51 md:flex-1 sm:flex-1 h-[1979px] md:h-[1px] sm:h-[1px] md:w-[100%] sm:w-[100%] w-[1px]" />
          <div className="flex md:flex-1 sm:flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] md:w-[100%] sm:w-[100%] w-[84%]">
            <Header1 className="bg-white_A700 flex items-center justify-center w-[100%]" />
            <div className="bg-gray_51 flex flex-col items-center justify-end p-[22px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col items-center justify-start mb-[10px] mt-[17px] w-[100%]">
                <div className="flex sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-center justify-between md:w-[100%] sm:w-[100%] w-[99%]">
                  <Text
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start mt-[32px] p-[30px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[48px] items-center justify-start mb-[50px] w-[100%]">
                    <div className="flex md:flex-col sm:flex-col flex-row gap-[37px] items-center justify-between w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between md:w-[100%] sm:w-[100%] w-[auto]">
                        <List
                        ...
                        >
                          <Img
                            ...
                            className="h-[126px] md:h-[auto] sm:h-[auto] my-[0] object-cover w-[100%]"
                            alt="Rectangle"
                          />
                          <Img
                        ...
                        <Img
                          ...
                          className="h-[564px] sm:h-[auto] object-cover md:w-[100%] sm:w-[100%] w-[auto]"
                          alt="Rectangle Four"
                        />
                      </div>
                      <div className="flex md:flex-1 sm:flex-1 flex-col items-start justify-end pt-[5px] md:w-[100%] sm:w-[100%] w-[auto]">
                        <div className="flex flex-col gap-[26px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[3px] pb-[3px] md:w-[100%] sm:w-[100%] w-[53%]">
                          <Text
                          ...
                          <div className="flex flex-row gap-[18px] items-center justify-between w-[100%]">
                            ...
                            <Img
                              ...
                              className="h-[14px] md:h-[auto] sm:h-[auto] object-cover w-[auto]"
                              alt="Frame"
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-[19px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[3px] mt-[32px] pr-[4px] pt-[4px] md:w-[100%] sm:w-[100%] w-[28%]">
                          <Text
                        ...
                        <div className="flex flex-col gap-[16px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[3px] mt-[32px] pr-[5px] pt-[5px] md:w-[100%] sm:w-[100%] w-[35%]">
                          <Text
                            className="font-medium text-bluegray_800 text-left w-[auto]"
                            as="h5"
                            variant="h5"
                          ...
                          <div className="flex flex-row items-center justify-start md:w-[100%] sm:w-[100%] w-[87%]">
                            <div className="border border-indigo_51 border-solid flex flex-col h-[32px] items-center justify-start p-[9px] w-[32px]">
                              <div className="bg-bluegray_900 h-[1px] my-[5px] rounded-radius083 w-[93%]"></div>
                            </div>
                            <Text
                        ...
                        <div className="flex flex-col items-start justify-start md:ml-[0] sm:ml-[0] ml-[3px] mt-[32px] md:w-[100%] sm:w-[100%] w-[39%]">
                          <Text
                          ...
                          <div className="flex flex-row gap-[8px] items-center justify-start mt-[19px] md:w-[100%] sm:w-[100%] w-[75%]">
                            <Button
                          ...
                          <Text
                            className="font-normal md:ml-[0] sm:ml-[0] ml-[2px] mt-[21px] not-italic text-indigo_401 text-left w-[auto]"
                            as="h6"
                            variant="h6"
                          >
                        ...
                        <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-between md:ml-[0] sm:ml-[0] ml-[3px] mt-[32px] w-[100%]">
                          <Button
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-start justify-between w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 flex-col gap-[27px] items-start justify-start md:mt-[0] sm:mt-[0] mt-[4px] md:w-[100%] sm:w-[100%] w-[auto]">
                        <Text
                      ...
                      <List
                        className="flex-col md:gap-[20px] sm:gap-[20px] grid w-[auto]"
                        orientation="vertical"
                      >
                        <div className="border border-indigo_51 border-solid flex flex-col items-center justify-start my-[0] p-[32px] sm:px-[20px] rounded-radius4 w-[100%]">
                          <div className="flex flex-col gap-[40px] items-end justify-start w-[100%]">
                            <div className="flex md:flex-col sm:flex-col flex-row md:gap-[52px] sm:gap-[52px] items-start justify-between w-[100%]">
                              <div className="flex md:flex-1 sm:flex-1 sm:flex-col flex-row gap-[20px] items-start justify-between md:w-[100%] sm:w-[100%] w-[auto]">
                                <Img
                              ...
                              <Text
                                className="font-normal md:mt-[0] sm:mt-[0] mt-[5px] not-italic text-bluegray_400 text-left w-[auto]"
                                as="h5"
                                variant="h5"
                              >
                                20 mins ago
                            ...
                            <div className="flex flex-row gap-[30px] items-center justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[35%]">
                        ...
                        <div className="border border-indigo_51 border-solid flex flex-col items-center justify-start my-[0] p-[32px] sm:px-[20px] rounded-radius4 w-[100%]">
                          <div className="flex flex-col gap-[16px] items-end justify-start w-[100%]">
                            <div className="flex sm:flex-col flex-row sm:gap-[40px] items-start justify-between w-[100%]">
                              <div className="flex sm:flex-1 sm:flex-col flex-row gap-[20px] items-start justify-between sm:w-[100%] w-[auto]">
                                <Img
                ...
                <div className="flex flex-row font-poppins md:gap-[40px] sm:gap-[40px] items-start justify-between mt-[36px] w-[100%]">
                  <Text
                  ...
                  <div className="flex flex-row font-inter gap-[16px] items-center justify-between mb-[4px] w-[auto]">
                    <Text
                      className="font-medium text-bluegray_400 text-left w-[auto]"
                      as="h5"
                      variant="h5"
                ...
                >
                  <div className="bg-white_A700 flex flex-1 flex-col gap-[32px] items-center justify-start pb-[32px] rounded-radius8 shadow-bs w-[100%]">
                    <div
                      className="bg-cover bg-no-repeat flex flex-col items-end justify-start p-[20px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_group16028.png')",
                      }}
                    >
                      <div className="flex flex-row gap-[8px] items-center justify-end mb-[283px] ml-[auto] md:w-[100%] sm:w-[100%] w-[81%]">
                        <Button
                        ...
                        >
                          <div className="bg-transparent cursor-pointer font-normal not-italic text-[12px] text-indigo_401 text-left">
                            Flash sale
                          </div>
                        </Button>
                      </div>
                    ...
                    <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[42%]">
                      <div className="flex flex-col gap-[32px] items-center justify-start w-[100%]">
                        <div className="flex flex-col gap-[16px] items-center justify-start pt-[3px] md:w-[100%] sm:w-[100%] w-[96%]">
                          ...
                          <Img
                            src="images/img_frame_11X77.png"
                            className="h-[11px] md:h-[auto] sm:h-[auto] object-cover w-[72%]"
                            alt="Frame One"
                          />
                        </div>
                  ...
                  <div className="bg-white_A700 flex flex-1 flex-col gap-[32px] items-center justify-start pb-[32px] rounded-radius8 shadow-bs w-[100%]">
                    ...
                    <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[42%]">
                      <div className="flex flex-col gap-[32px] items-center justify-start w-[100%]">
                        <div className="flex flex-col gap-[16px] items-center justify-start pt-[5px] md:w-[100%] sm:w-[100%] w-[96%]">
                      ...
                      <div className="flex flex-col gap-[32px] items-center justify-start w-[100%]">
                        <div className="flex flex-col gap-[16px] items-center justify-start pt-[3px] md:w-[100%] sm:w-[100%] w-[96%]">
                          <div className="flex flex-col gap-[17px] justify-start w-[100%]">
                            <Text
                              className="font-medium md:ml-[0] sm:ml-[0] ml-[14px] text-bluegray_900 text-left w-[auto]"
                              as="h6"
                              variant="h6"
                            >
                              Over Shirt
