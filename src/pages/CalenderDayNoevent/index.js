                ...
                <div className="flex md:flex-col sm:flex-col flex-row font-inter gap-[20px] items-center justify-between w-[100%]">
                  ...
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[6px] md:w-[100%] sm:w-[100%] w-[99%]">
                      ...
                      <div className="border border-indigo_51 border-solid flex flex-col items-center justify-start py-[12px] w-[100%]">
                        <Text
                        ...
                        >
                          ...
                          <span className="text-indigo_401 text-[16px] font-inter font-medium">
                            Create new
                          </span>
                        </Text>
                      </div>
