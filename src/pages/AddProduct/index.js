    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[1071px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col items-center justify-start my-[13px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-end mt-[35px] p-[32px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                  <div className="flex flex-col items-start justify-start mt-[5px] w-[100%]">
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row md:gap-[54px] sm:gap-[54px] items-center justify-between mt-[40px] w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 flex-col gap-[13px] items-start justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                        <Text
                          className="font-medium text-bluegray_800 text-left w-[auto]"
                          as="h6"
                          variant="h6"
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row md:gap-[54px] sm:gap-[54px] items-center justify-between mt-[28px] w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 flex-col gap-[27px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                ...
                <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between mt-[20px] w-[100%]">
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-end p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <Text
                    ...
                    <div className="border-2 border-dashed border-indigo_51 flex flex-col items-center justify-end p-[87px] sm:px-[20px] md:px-[40px] rounded-radius4 w-[100%]">
                      <div className="flex flex-col gap-[40px] items-center justify-start mt-[10px] md:w-[100%] sm:w-[100%] w-[67%]">
                        <Img
                  ...
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col justify-end p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <Text
                      className="font-bold md:ml-[0] sm:ml-[0] ml-[6px] mr-[435px] mt-[11px] text-bluegray_900 text-left w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      Add link
                    </Text>
                    <div className="flex flex-col gap-[29px] items-center justify-start mr-[6px] mt-[36px] pt-[3px] md:w-[100%] sm:w-[100%] w-[99%]">
                      <div className="flex flex-col gap-[12px] items-start justify-start w-[100%]">
                        <Text
                          className="font-medium text-bluegray_800 text-left w-[auto]"
                          as="h6"
                    ...
                    <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-end mb-[6px] md:ml-[0] sm:ml-[0] ml-[195px] mr-[6px] mt-[62px] md:w-[100%] sm:w-[100%] w-[61%]">
                      <Button
