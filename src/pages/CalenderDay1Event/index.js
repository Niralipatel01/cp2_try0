              ...
              <div className="flex flex-col gap-[38px] items-start justify-start mb-[75px] mt-[14px] w-[100%]">
                ...
                <div className="flex md:flex-col sm:flex-col flex-row font-inter gap-[20px] items-center justify-between w-[100%]">
                  ...
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[6px] md:w-[100%] sm:w-[100%] w-[99%]">
                      ...
                      <div className="border border-indigo_51 border-solid flex flex-col gap-[13px] items-center justify-start py-[12px] w-[100%]">
                        <Text
                        ...
                        <div className="flex flex-col items-center justify-start mb-[547px] w-[100%]">
                          <Line className="bg-indigo_51 h-[1px] w-[100%]" />
                          <div className="bg-indigo_401 flex flex-col items-start justify-start mt-[3px] p-[4px] rounded-radius4 md:w-[100%] sm:w-[100%] w-[99%]">
                            <div className="flex flex-row items-end justify-start mb-[4px] md:ml-[0] sm:ml-[0] ml-[12px] md:w-[100%] sm:w-[100%] w-[31%]">
                              <Img
                                src="images/img_oval.svg"
                                className="h-[8px] mb-[2px] mt-[7px] w-[1%]"
                                alt="Oval"
                              />
                              <Text
                              ...
                              <Text
                                className="font-semibold ml-[9px] text-left text-white_A700 w-[auto]"
                                as="h6"
                                variant="h6"
                              >
