...
const ConversationPage = () => {
  ...
  return (
    <>
      <div className="flex flex-col font-inter items-center justify-end mx-[auto] w-[100%]">
        <div className="bg-white_A700 h-[1084px] md:h-[2357px] sm:h-[2357px] relative w-[100%]">
          <div className="absolute bg-white_A700 flex flex-row inset-x-[0] items-center justify-end mx-[auto] sm:pl-[20px] pl-[241px] md:pl-[40px] top-[0] w-[100%]">
            <div className="flex flex-1 md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
              <Line className="bg-indigo_51 md:flex-1 sm:flex-1 md:h-[1px] sm:h-[1px] h-[927px] md:w-[100%] sm:w-[100%] w-[1px]" />
          ...
          <div className="absolute bg-gray_51 bottom-[0] flex flex-col font-poppins gap-[32px] items-start justify-center p-[23px] sm:px-[20px] right-[0] w-[84%]">
            ...
            <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row font-inter gap-[26px] items-center justify-end mb-[158px] sm:pl-[20px] pl-[32px] rounded-radius4 shadow-bs w-[100%]">
              <div className="flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-start justify-start md:w-[100%] sm:w-[100%] w-[35%]">
                <div className="flex flex-row gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[46%]">
                  <Button
                    className="flex h-[62px] items-center justify-center rounded-radius50 w-[62px]"
                    size="mdIcn"
                  ...
                  <div className="flex flex-col gap-[13px] items-start justify-start pr-[5px] pt-[5px] w-[57%]">
                    <Text
                  ...
                  <div className="flex flex-row gap-[24px] items-center justify-between w-[100%]">
                    ...
                    >
                      <div className="flex flex-col gap-[12px] items-center justify-start mb-[3px] sm:ml-[0] w-[100%]">
                        <div className="md:h-[48px] sm:h-[48px] h-[51px] relative w-[100%]">
                          <Img
                            src="images/img_punktoyface1.png"
                            className="absolute h-[48px] inset-x-[0] mx-[auto] rounded-radius50 top-[0] w-[48px]"
                            alt="PunkToyFaceOne"
                          />
                          <div className="absolute bg-green_700 bottom-[0] h-[11px] outline outline-[2px] outline-white_A700 right-[4%] rounded-radius50 w-[11px]"></div>
                        </div>
                        <Text
                      ...
                      <div className="flex flex-col gap-[11px] items-center justify-start mb-[4px] sm:ml-[0] w-[100%]">
                        <div className="md:h-[48px] sm:h-[48px] h-[51px] relative w-[100%]">
                          <Img
                            ...
                            alt="Indiahigh"
                          />
                          <div className="absolute bg-bluegray_200 bottom-[0] h-[11px] outline outline-[2px] outline-white_A700 right-[4%] rounded-radius50 w-[11px]"></div>
                        </div>
                        <Text
                          className="font-medium text-bluegray_900 text-left w-[auto]"
                          as="h5"
                      ...
                      <div className="flex flex-col gap-[12px] items-start justify-start mb-[3px] sm:ml-[0] w-[100%]">
                        ...
                        <Text
                          className="font-medium md:ml-[0] sm:ml-[0] ml-[3px] text-bluegray_900 text-left w-[auto]"
                          as="h5"
                          variant="h5"
                        >
                          Jimo
                      ...
                      <div className="flex flex-col gap-[12px] items-start justify-start sm:ml-[0] pb-[2px] pr-[2px] w-[100%]">
                        <div className="md:h-[48px] sm:h-[48px] h-[51px] md:ml-[0] sm:ml-[0] ml-[2px] relative w-[96%]">
                          <Img
                ...
                <Input
                  ...
                  wrapClassName="flex md:w-[100%] sm:w-[100%] w-[99%]"
                  name="SearchBox One"
                  placeholder="Search..."
                  prefix={
                    <Img
                ...
                ></Input>
                <List
                  className="flex-col grid items-center pb-[20px] md:w-[100%] sm:w-[100%] w-[99%]"
                  orientation="vertical"
                >
                  <div className="flex flex-row gap-[20px] items-center justify-between w-[100%]">
                    <div className="md:h-[48px] sm:h-[48px] h-[51px] relative w-[auto]">
                      <Img
                        src="images/img_punktoyface1.png"
                        className="absolute h-[48px] inset-x-[0] mx-[auto] rounded-radius50 top-[0] w-[48px]"
                    ...
                    <div className="flex flex-row items-center justify-between w-[auto]">
                      ...
                      <div className="flex flex-col gap-[13px] items-start justify-end pl-[2px] pt-[2px] w-[auto]">
                        ...
                        <Text
                          className="bg-red_600 flex font-bold h-[24px] items-center justify-center md:ml-[0] sm:ml-[0] ml-[4px] rounded-radius50 text-center text-white_A700 w-[24px]"
                          variant="body1"
                        >
                          3
                        </Text>
                  ...
                  <div className="flex flex-row gap-[20px] items-center justify-between w-[100%]">
                    ...
                    <div className="flex flex-row items-center justify-between w-[auto]">
                      ...
                      <div className="flex flex-col items-center justify-start pl-[2px] py-[2px] w-[55px]">
                        <Text
              ...
              <Line className="bg-indigo_51 md:flex-1 sm:flex-1 md:h-[1px] sm:h-[1px] h-[747px] md:w-[100%] sm:w-[100%] w-[1px]" />
              <div className="flex md:flex-1 sm:flex-1 flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[63%]">
                <div className="flex flex-col items-center justify-start w-[100%]">
                  <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-start md:w-[100%] sm:w-[100%] w-[92%]">
                    <div className="flex flex-col gap-[12px] items-start justify-end pr-[3px] pt-[3px] md:w-[100%] sm:w-[100%] w-[15%]">
                      <Text
                    ...
                    <Button
                      className="flex h-[48px] items-center justify-center mb-[10px] md:ml-[0] sm:ml-[0] ml-[437px] rounded-radius50 w-[48px]"
                      size="xlIcn"
                    ...
                    <Button
                      className="flex h-[48px] items-center justify-center mb-[10px] md:ml-[0] sm:ml-[0] ml-[16px] rounded-radius50 w-[48px]"
                      size="xlIcn"
                      variant="icbFillGray51"
                    >
                      <Img
                  ...
                  <div className="flex flex-col items-start justify-start mt-[31px] md:w-[100%] sm:w-[100%] w-[92%]">
                    <div className="h-[104px] md:h-[82px] sm:h-[82px] pt-[4px] relative md:w-[100%] sm:w-[100%] w-[50%]">
                      <div className="absolute flex flex-col gap-[12px] inset-x-[0] justify-start mx-[auto] top-[0] w-[100%]">
                        <Text
                        ...
                        <div className="flex flex-row gap-[12px] items-start justify-between w-[100%]">
                          ...
                          />
                          <div className="bg-gray_51 flex flex-col items-start justify-end p-[16px] rounded-bl-[4px] rounded-br-[4px] rounded-tl-[0] rounded-tr-[4px] w-[auto]">
                            <Text
                      ...
                      <Text
                        className="absolute bg-gray_51 border-2 border-solid border-white_A700 bottom-[0] font-normal h-[28px] not-italic px-[6px] py-[5px] right-[3%] rounded-radius50 text-black_900 text-left w-[28px]"
                        as="h5"
                        variant="h5"
                      >
                        😍
                    ...
                    <div className="flex flex-row gap-[8px] items-end justify-end ml-[auto] mt-[5px] md:w-[100%] sm:w-[100%] w-[49%]">
                      <Input
                        className="font-medium p-[0] text-[16px] placeholder:text-bluegray_800 text-bluegray_800 text-left w-[100%]"
                        wrapClassName="sm:w-[100%] w-[91%]"
                        name="Group Three"
                    ...
                    <div className="flex flex-row gap-[8px] items-end justify-end ml-[auto] mt-[16px] md:w-[100%] sm:w-[100%] w-[49%]">
                      <div className="bg-gray_51 flex flex-col gap-[16px] items-start justify-start p-[16px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[8px] w-[91%]">
                        <div
                          className="bg-cover bg-no-repeat flex flex-col items-end justify-end p-[8px] rounded-radius8 w-[100%]"
                          style={{
                        ...
                        <div className="flex flex-col gap-[13px] items-start justify-start md:w-[100%] sm:w-[100%] w-[84%]">
                          <Text
                    ...
                    <div className="bg-gray_51 flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start mt-[105px] p-[9px] rounded-radius4 w-[100%]">
                      <Input
                        className="flex-1 font-normal not-italic p-[0] text-[16px] placeholder:text-bluegray_400 text-bluegray_400 text-left w-[100%]"
                        wrapClassName="md:ml-[0] md:w-[100%] ml-[4px] sm:ml-[0] sm:w-[100%] w-[75%]"
                        name="frame3801"
                      ...
                      <Img
                        ...
                        className="h-[24px] md:ml-[0] sm:ml-[0] ml-[17px] w-[24px]"
                        alt="share"
                      />
                      <Img
                        src="images/img_link.svg"
                        className="h-[24px] md:ml-[0] sm:ml-[0] ml-[24px] w-[24px]"
                        alt="link"
                      />
                      <Img
          ...
          <aside className="absolute flex flex-col font-inter md:hidden sm:hidden left-[0] top-[0] w-[17%]">
