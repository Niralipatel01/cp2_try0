    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[240px]">
            <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[31px] sm:px-[20px] w-[100%]">
              <Img
                ...
                alt="Logo"
              />
              <div className="flex flex-col items-start justify-start mb-[493px] md:w-[100%] sm:w-[100%] w-[88%]">
                <div
                ...
                <div className="flex flex-row gap-[16px] items-end justify-start mt-[34px] md:w-[100%] sm:w-[100%] w-[46%]">
                  <Img
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[990px] mb-[34px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[43px] mt-[14px] w-[100%]">
                <div className="flex sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-start justify-between md:w-[100%] sm:w-[100%] w-[99%]">
                  <Text
                ...
                <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[32px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col items-start justify-start mb-[4px] w-[100%]">
                      <div className="flex flex-col gap-[12px] items-start justify-end pr-[4px] py-[4px] md:w-[100%] sm:w-[100%] w-[30%]">
                        <Text
                      ...
                      <div className="flex md:flex-col sm:flex-col flex-row gap-[23px] items-center justify-between mt-[27px] w-[100%]">
                  ...
                  <div className="flex md:flex-1 sm:flex-1 flex-col gap-[32px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                      ...
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        <div className="flex flex-row gap-[24px] items-center justify-between w-[100%]">
                          <Img
                            ...
                            className="h-[118px] md:h-[auto] sm:h-[auto] object-cover w-[auto]"
                            alt="Rectangle"
                          />
                          <div className="flex flex-col gap-[41px] items-start justify-start pb-[4px] w-[auto]">
                            <div className="flex flex-col gap-[19px] items-start justify-start md:w-[100%] sm:w-[100%] w-[55%]">
                              <Text
                    ...
                    <Button
                      ...
                      size="sm"
                    >
                      <div className="bg-transparent cursor-pointer font-medium text-[16px] text-indigo_401 text-left">
