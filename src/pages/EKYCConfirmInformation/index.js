          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[72px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start p-[48px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[21px] justify-start md:w-[100%] sm:w-[100%] w-[31%]">
                    <Text
                      className="md:ml-[0] sm:ml-[0] ml-[25px] text-bluegray_900 text-left w-[auto]"
                      as="h2"
                      variant="h2"
                    >
                      Confirm Information
                  ...
                  <div className="flex flex-col items-center justify-start mt-[32px] pt-[4px] md:w-[100%] sm:w-[100%] w-[67%]">
                    ...
                    <div className="md:gap-[20px] sm:gap-[20px] gap-[23px] grid md:grid-cols-1 sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] mt-[24px] w-[100%]">
                  ...
                  <CheckBox
                    className="font-normal mt-[48px] not-italic text-[14px] text-bluegray_400 text-left md:w-[100%] sm:w-[100%]"
