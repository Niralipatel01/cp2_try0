    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[241px]">
            <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[32px] sm:px-[20px] w-[100%]">
              <Img
                ...
                alt="Logo"
              />
              <div className="flex flex-col items-start justify-start mb-[643px] md:w-[100%] sm:w-[100%] w-[88%]">
                <div className="flex flex-row gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[71%]">
                  <Img
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[1175px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            <Header className="bg-white_A700 flex items-center justify-center w-[100%]" />
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start p-[11px] w-[100%]">
              <div className="flex flex-col gap-[20px] items-center justify-start my-[13px] md:w-[100%] sm:w-[100%] w-[99%]">
                <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[99%]">
                  ...
                  >
                    <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start p-[24px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                      <div className="flex flex-row items-center justify-between pb-[4px] md:w-[100%] sm:w-[100%] w-[87%]">
                        <Img
                        ...
                        <div className="flex flex-col items-center justify-start w-[auto]">
                          <div className="flex flex-col items-start justify-start w-[100%]">
                            <div className="flex h-[40px] md:h-[auto] sm:h-[auto] relative w-[100%]">
                              <Text
                              ...
                              <div className="bg-green_700_63 flex flex-row items-start justify-center ml-[-1px] mt-[7px] pr-[3px] rounded-radius4 w-[32%] z-[1]">
                                <Img
                            ...
                            <div className="flex flex-row gap-[6px] items-center justify-start mt-[3px] md:w-[100%] sm:w-[100%] w-[59%]">
                              <div className="bg-indigo_400 h-[6px] my-[3px] rounded-radius50 w-[6px]"></div>
                              <Text
                    ...
                    <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start p-[24px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                      <div className="flex flex-row items-center justify-between md:w-[100%] sm:w-[100%] w-[87%]">
                        <Img
                        ...
                        <div className="flex flex-row items-start justify-start w-[auto]">
                          <div className="flex flex-col items-center justify-start w-[70%]">
                            <div className="flex flex-col gap-[5px] items-start justify-start w-[100%]">
                              ...
                              <div className="flex flex-row items-start justify-evenly md:w-[100%] sm:w-[100%] w-[96%]">
                                <div className="bg-indigo_400 h-[6px] mb-[8px] mt-[2px] rounded-radius50 w-[6px]"></div>
                                <Text
                                  className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                                  as="h6"
                                  variant="h6"
                          ...
                          <div className="bg-red_600_63 flex flex-row items-start justify-center mb-[34px] mt-[7px] pr-[3px] rounded-radius4 w-[32%]">
                            <Img
                      ...
                      <div className="flex flex-row items-center justify-between pb-[4px] md:w-[100%] sm:w-[100%] w-[87%]">
                        ...
                        <div className="flex flex-col items-center justify-start w-[auto]">
                          <div className="flex flex-col items-start justify-start w-[100%]">
                            ...
                            <div className="flex flex-row gap-[6px] items-center justify-start mt-[4px] md:w-[100%] sm:w-[100%] w-[64%]">
                              <div className="bg-indigo_400 h-[6px] my-[4px] rounded-radius50 w-[6px]"></div>
                              <Text
                                className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                                as="h6"
                                variant="h6"
                  ...
                  <div className="flex md:flex-col sm:flex-col flex-row font-inter gap-[19px] items-center justify-between mt-[20px] w-[100%]">
                    <div className="flex md:flex-1 sm:flex-1 flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                      <div className="bg-white_A700 flex flex-col gap-[31px] items-center justify-start p-[26px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                        <div className="flex flex-row sm:gap-[40px] items-center justify-between md:w-[100%] sm:w-[100%] w-[99%]">
                          <Text
                        ...
                        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[44px] sm:gap-[44px] items-start justify-between mb-[14px] md:w-[100%] sm:w-[100%] w-[99%]">
                          <div className="flex flex-col gap-[19px] items-start justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                            <div className="flex flex-row gap-[8px] items-start justify-start md:w-[100%] sm:w-[100%] w-[82%]">
                              <div className="bg-indigo_401 h-[6px] mb-[2px] mt-[5px] rounded-radius50 w-[6px]"></div>
                              <Text
                                className="font-medium text-bluegray_400 text-left w-[auto]"
                                variant="body1"
                              >
                            ...
                            <div className="flex flex-row gap-[8px] items-center justify-start w-[100%]">
                              <div className="bg-amber_300 h-[6px] my-[5px] rounded-radius50 w-[6px]"></div>
                              <Text
                                className="font-medium text-bluegray_400 text-left w-[auto]"
                                variant="body1"
                              >
                          ...
                          <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                            <div className="flex flex-col gap-[15px] items-end justify-start w-[100%]">
                              <div className="flex sm:flex-col flex-row gap-[22px] items-center justify-between w-[100%]">
                                ...
                                <div
                                  className="bg-cover bg-no-repeat font-poppins md:h-[206px] sm:h-[206px] h-[227px] pt-[17px] px-[17px] relative sm:w-[100%] w-[auto]"
                                  style={{
                                    backgroundImage:
                                ...
                                >
                                  ...
                                  />
                                  <div
                                    className="absolute bg-cover bg-no-repeat md:h-[41px] sm:h-[41px] h-[84px] left-[7%] p-[13px] shadow-bs1 top-[19%] w-[30%]"
                                    style={{
                                      backgroundImage:
                                  ...
                                  >
                                    ...
                                    <div className="absolute flex flex-col items-center justify-start left-[15%] top-[23%] w-[75%]">
                                      <div className="flex flex-col gap-[17px] justify-start w-[100%]">
                                        <div className="flex flex-row gap-[8px] items-start justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[43%]">
                                          <div className="bg-amber_300 h-[6px] mb-[4px] rounded-radius50 w-[6px]"></div>
                                          <Text
                                            className="font-semibold text-bluegray_900 text-left w-[auto]"
                                            variant="body1"
                                          >
                              ...
                              <div className="flex sm:flex-col flex-row sm:gap-[20px] items-start justify-end ml-[auto] pb-[2px] px-[2px] md:w-[100%] sm:w-[100%] w-[91%]">
                                <Text
                                  className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                                  variant="body1"
                                >
                    ...
                    <div className="md:h-[200px] sm:h-[200px] h-[410px] relative sm:w-[100%] w-[auto]">
                      <div className="absolute md:h-[100px] sm:h-[100px] h-[116px] inset-x-[0] mx-[auto] top-[23%] w-[100%]">
                        <Img
                      ...
                      <div className="absolute bg-deep_orange_300 md:h-[200px] sm:h-[200px] h-[211px] inset-x-[0] mx-[auto] p-[5px] rounded-bl-[0] rounded-br-[0] rounded-tl-[4px] rounded-tr-[4px] shadow-bs top-[0] w-[100%]">
                        <Img
                      ...
                      <div className="absolute bg-white_A700 bottom-[0] flex flex-col inset-x-[0] items-start justify-end mx-[auto] p-[24px] sm:px-[20px] rounded-bl-[4px] rounded-br-[4px] rounded-tl-[0] rounded-tr-[0] shadow-bs w-[100%]">
                        <div className="flex flex-col gap-[20px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[7px] mt-[5px] md:w-[100%] sm:w-[100%] w-[76%]">
                          <div className="flex flex-col gap-[11px] items-start justify-start md:w-[100%] sm:w-[100%] w-[93%]">
                            <Text
                ...
                <div className="flex md:flex-col sm:flex-col flex-row font-inter md:gap-[51px] sm:gap-[51px] items-center justify-between w-[100%]">
                  <div className="flex md:flex-1 sm:flex-1 flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[16px] justify-start w-[100%]">
                      <div className="flex flex-col gap-[28px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[44px] md:w-[100%] sm:w-[100%] w-[95%]">
                        ...
                        <SelectBox
                          className="font-medium text-[14px] text-bluegray_800 text-left md:w-[100%] sm:w-[100%] w-[44%]"
                          placeholderClassName="text-bluegray_800"
                          name="language"
                      ...
                      <div className="flex md:h-[224px] sm:h-[224px] h-[248px] mr-[12px] relative md:w-[100%] sm:w-[100%] w-[99%]">
                        <div className="md:h-[161px] sm:h-[161px] h-[248px] my-[auto] sm:w-[100%] w-[60%]">
                          <Button
                          ...
                          <div className="absolute md:h-[161px] sm:h-[161px] h-[240px] inset-[0] justify-center m-[auto] w-[100%]">
                            <div className="absolute bg-indigo_401 flex flex-col gap-[108px] md:gap-[40px] sm:gap-[40px] justify-start left-[10%] p-[20px] rounded-radius4 top-[0] w-[70%]">
                              <Img
                                src="images/img_group_12X40.svg"
                                className="h-[12px] md:ml-[0] sm:ml-[0] ml-[221px] w-[16%]"
                                alt="Group Four"
                              />
                              <Text
                                className="font-medium mb-[7px] md:ml-[0] sm:ml-[0] ml-[2px] mr-[97px] text-left text-white_A700 w-[auto]"
                                as="h5"
                                variant="h5"
                              >
                                1234 **** 4567 8901{" "}
                  ...
                  <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-end justify-end pt-[16px] px-[16px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                    <div className="flex flex-col gap-[37px] items-start justify-start mt-[21px] md:w-[100%] sm:w-[100%] w-[96%]">
                      <Text
                        className="font-bold text-bluegray_900 text-left w-[auto]"
                        as="h4"
                        variant="h4"
                      ...
                      <div className="flex flex-row gap-[32px] items-start justify-between w-[100%]">
                        ...
                        >
                          <div className="flex flex-row items-center justify-between my-[0] w-[100%]">
                            <div className="flex flex-row gap-[16px] items-center justify-between py-[2px] w-[auto]">
                              <Img
                          ...
                          <Line className="self-center h-[1px] bg-indigo_51 w-[100%]" />
                          <div className="flex flex-col items-center justify-start mr-[114px] my-[0] md:w-[100%] sm:w-[100%] w-[61%]">
                            <div className="flex flex-row gap-[16px] items-start justify-between pt-[2px] w-[100%]">
                              <Img
                                src="images/img_tintin22.png"
                                className="h-[13px] md:h-[auto] sm:h-[auto] object-cover rounded-radius23 w-[auto]"
                                alt="TinTinTwentyTwo"
                              />
                        ...
                        <div className="bg-gray_51 flex flex-col items-center justify-start mb-[32px] pb-[177px] rounded-radius2 w-[auto]">
